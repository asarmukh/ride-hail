...
func (r *DriveRepo) InsertDriver(ctx context.Context, driverData *models.Driver) error {
...
func (r *DriveRepo) CheckLicenseNumberExists(ctx context.Context, licenseNumber string) (bool, error) {
